...
1. Compound Registration
    ...
    * [x] **Structure Standardization**: Converts entered structures into a consistent format, handling tautomerization, salts, and stereo conventions.
2. Metadata
    * [x] **Custom Attributes**: Supports capturing custom metadata (e.g., biological data, physicochemical properties, origin information) and ties it to the appropriate entity (compound, batch/lot).
...
4. Protocols and Assay Results
    * [x] **Protocols**: Define assay types used to measure batches.
    * [x] **Assay Results**: Register and query assay results.
5. Search
...
8. User Interface
    * [x] **Chemical Drawing Integration**: Allows users to input structures directly using chemical drawing tools (e.g., MarvinJS, ChemDraw, Ketcher).
